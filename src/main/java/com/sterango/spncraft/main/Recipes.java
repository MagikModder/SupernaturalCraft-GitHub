...
<<<<<<< HEAD:src/main/java/com/sterango/spncraft/Recipes.java
import com.sterango.spncraft.Items.ModItems;
=======
import com.sterango.spncraft.Common.items.ModItems;
>>>>>>> origin/master:src/main/java/com/sterango/spncraft/main/Recipes.java
...
public class Recipes
{
	...
	public static void addRecipes() 
	{
		...
		GameRegistry.addRecipe(new ItemStack(SupernaturalCraft.DeathsScythe), new Object[]
				{
					" AA",
					" S ",
					"S  ",
					'A', SupernaturalCraft.AngelicIron, 'S', SupernaturalCraft.SoulStick
				});
		
		
		GameRegistry.addRecipe(new ItemStack(SupernaturalCraft.SoulStick), new Object[]
				{
					"   ",
					" X ",
					" X ",
					'X', SupernaturalCraft.Soul
				});
		...
		GameRegistry.addRecipe(new ItemStack(SupernaturalCraft.AngelBlade), new Object[]
				{
					...
					" X ",
					"Y  ",
					'X', SupernaturalCraft.AngelicIron, 'Y', Items.stick
				});
		...
		GameRegistry.addRecipe(new ItemStack(SupernaturalCraft.Colt), new Object[]
				{
					...
					'A', SupernaturalCraft.Silver, 'B', Items.stick, 'C', SupernaturalCraft.ColtAmmo, 'D', Items.gunpowder 
				});
		...
		GameRegistry.addRecipe(new ItemStack(SupernaturalCraft.DevilsTrap), new Object[]
				{
					...
					"SRS",
					"RSR",
					'S', Blocks.wool, 'R', Blocks.stone
				});
		
		
		GameRegistry.addRecipe(new ItemStack(SupernaturalCraft.BloodyDevilsTrap), new Object[]
				{
					"RSR",
					"SRS",
					"RSR",
					'S', SupernaturalCraft.LambsBlood, 'R', Blocks.stone
				});
