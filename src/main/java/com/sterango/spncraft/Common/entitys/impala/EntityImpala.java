...
public class EntityImpala extends Entity implements IEntityAdditionalSpawnData, IInventory
{
	public double speed;
	...
	public EntityImpala(World world, int x, int y, int z, int colour, String owner)
	{
		this(world);
	...
	public boolean attackEntityFrom(DamageSource damageSource, float damage)
	{
		...
		else if (!this.worldObj.isRemote && !this.isDead)
		{
			...
			if (isCreativeMode || this.getDamageTaken() > 40.0F)
			{
				...
				if (!isCreativeMode)
				{
					this.func_145778_a(SupernaturalCraft.getCarDrop(carColour), 1, 0.0F);
